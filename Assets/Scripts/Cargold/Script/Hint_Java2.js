...
function Update () {
    if(a==1){
        ...
        str[10] =  "NC소프트는 상향세이다.";
        str[11] = " NC소프트는 상향세가 아니다.";
        str[12] = " NC소프트는 하향세이다.";
        str[13] = " NC소프트는 하향세가 아니다.";
        str[14] = " NC소프트는 동결이다.";
        str[15] = " NC소프트는 동결이 아니다.";

        str[16] = " 네오위즈는 상향세이다.";
        str[17] = " 네오위즈는 상향세가 아니다.";
        str[18] = " 네오위즈는 하향세이다.";
        str[19] = " 네오위즈는 하향세가 아니다.";
        str[20] = " 네오위즈는 동결이다.";
        str[21] = " 네오위즈는 동결이 아니다.";
        ...
        str[29] = " NC소프트는 2등이다.";
        str[30] = " NC소프트는 3등이다.";
        str[31] = " NC소프트는 1등이 아니다.";
        str[32] = " NC소프트는 2등이 아니다.";
        str[33] = " NC소프트는 3등이 아니다.";

        str[34] = " 네오위즈는 1등이다.";
        str[35] = " 네오위즈는 2등이다.";
        str[36] = " 네오위즈는 3등이다.";
        str[37] = " 네오위즈는 1등이 아니다.";
        str[38] = " 네오위즈는 2등이 아니다.";
        str[39] = " 네오위즈는 3등이 아니다.";
        ...
        str[47] = " 넥슨은 NC소프트보다 상향이다.";
        str[48] = " NC소프트는 넥슨보다 하향이다.";

        str[49] = " 넥슨은 네오위즈보다 상향이다.";
        str[50] = " 네오위즈는 넥슨보다 하향이다.";

        str[51] = " NC소프트는 네오위즈보다 상향이다.";
        str[52] = " 네오위즈는 NC소프트보다 하향이다.";

        str[53] = " 넥슨은 NC소프트보다 하향이다.";
        str[54] = " NC소프트는 넥슨보다 상향이다.";

        str[55] = " 넥슨은 네오위즈보다 하향이다.";
        str[56] = " 네오위즈는 넥슨보다 상향이다.";

        str[57] = " NC소프트는 네오위즈보다 하향이다.";
        str[58] = " 네오위즈는 NC소프트보다 상향이다.";
        ...
        str[98] = " 넥슨가 "+A.ToString()+"%의 변동을 보인다.";
        str[99] = " NC소프트가 "+B.ToString()+"%의 변동을 보인다.";
        str[100] = " 네오위즈가 "+C.ToString()+"%의 변동을 보인다.";
        if(A>B){
            str[101] = " 넥슨와 NC소프트의 변동차는 "+(A-B).ToString()+"%이다.";
        }else{
            str[101] = "  넥슨와 NC소프트의 변동차는 "+(B-A).ToString()+"%이다.";
        }
        if(A>C){
            str[102] = " 넥슨와 네오위즈의 변동차는 "+(A-C).ToString()+"%이다.";
        }else{
            str[102] = "  넥슨와 네오위즈의 변동차는 "+(C-A).ToString()+"%이다.";
        }
        if(B>C){
            str[103] = " NC소프트와 네오위즈의 변동차는 "+(B-C).ToString()+"%이다.";
        }else{
            str[103] = "  NC소프트와 네오위즈의 변동차는 "+(C-B).ToString()+"%이다.";
        }
        a=2;
    }
    if(a==2){
